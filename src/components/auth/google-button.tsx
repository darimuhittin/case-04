...
export function GoogleButton({
  ...
  return (
    <Button
      ...
      type="button"
      className={cn(
        "w-full h-12 gap-3 font-bold rounded-xl text-[#1A1A1A] border-gray-200 hover:bg-gray-50 text-sm",
        className
      )}
      disabled={disabled}
      onClick={onClick}
    ...
    >
      ...
      >
        ...
        />
        <path
          d="M12.2401 4.74966C13.9509 4.7232 15.6044 5.36697 16.8434 6.54867L20.2695 3.12262C18.1004 1.0855 15.2208 -0.0344664 12.2401 0.000808666C7.7029 0.000808666 3.55371 2.55822 1.5166 6.61481L5.50264 9.70575C6.45064 6.86173 9.10947 4.74966 12.2401 4.74966Z"
          fill="#EA4335"
        />
      </svg>
      {action === "sign in" ? "Sign in with Google" : "Sign up with google"}
    </Button>
  );
}
